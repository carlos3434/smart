<div class="modal fade" id="nuevo_modal">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="tab-content" style="min-height: 600px;">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" placeholder="dd-mm-yyyy" class="form-control datepicker" data-dateformat="dd-mm-yy" onfocus="blur()" name='DueDate_nuevo' v-model='tarea.DueDate'>
                                </div>
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-control" id="nuevo_mapa_tarea" style="height: 300px;"></div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" @click.prevent="guardarNuevo">Enviar</button>
            </div>
